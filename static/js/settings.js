    ...
    $("#btn-reboot-system").click(function(e) {
      if (confirm("Are you sure you want to reboot your Mediaz-Electronics Signage-Player?")) {
        return $.post("/api/v1/reboot_screenly").done(function(e) {
          ...
          ($("#request-error .alert")).addClass("alert-success");
          ($("#request-error .alert")).removeClass("alert-danger");
          return ($("#request-error .msg")).text("Mediaz-Electronics Signage-Player reboot has started successfully.");
        }).fail(function(data, e) {
          var err, j;
          ($("#request-error .alert")).show();
          ($("#request-error .alert")).addClass("alert-danger");
    ...
    $("#btn-shutdown-system").click(function(e) {
      if (confirm("Are you sure you want to shutdown your Mediaz-Electronics Signage-Player?")) {
        return $.post("/api/v1/shutdown_screenly").done(function(e) {
          ...
          ($("#request-error .alert")).addClass("alert-success");
          ($("#request-error .alert")).removeClass("alert-danger");
          return ($("#request-error .msg")).text("Mediaz-Electronics Signage-Player shutdown has started successfully. Soon you will be able to unplug the power from your Raspberry Pi.");
        }).fail(function(data, e) {
          var err, j;
          ($("#request-error .alert")).show();
          ($("#request-error .alert")).addClass("alert-danger");
